...
const tabs = [
  ...
  { to: "/settings/ai-screening",   label: "AI Screening" },
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="text-sm text-muted-foreground mt-0.5">Manage your workspace, hiring pipeline, onboarding, team, and integrations.</p>
      </div>
